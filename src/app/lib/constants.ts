...
export const TELECALLER_BOOKINGS_ADMIN_HOT_COLUMNS: ColumnSettings[] = [
  ...
  { data: 'community', title: 'Community', width: 125, source: COMMUNITY_LIST, type: 'dropdown' },
  ...
  { data: 'dataStatus', title: 'Data remarks', width: 150 },
...
export const TELECALLER_BOOKINGS_ADMIN_PREVIEW_HOT_COLUMNS: ColumnSettings[] = [
