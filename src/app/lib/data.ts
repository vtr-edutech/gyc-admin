...
export const DOMAIN_INTEREST_LIST = [
  'Engineering',
  'Arts & Science',
  'Law',
  'Paramedical',
...
export const COURSE_INTEREST_LIST = [
  'Aeronautical',
  'Automobile',
  ...
  'B.Com CA',
  'BBA',
  'HMCT (B.Sc. Hotel and Catering Management)',
  'B.A. LLB',
  'B.Com LLB',
  'BBA LLB',
  'LLB',
  ...
  'R&IT (Radiology and Imaging Technology)',
  'OTAT (Operation Theatre & Anaesthesia Technology)',
  'CT / CVT (Cardiac / Cardiovascular Technology)',
  'Renal Dialysis (Renal Dialysis Technology)',
  'Respiratory (Respiratory Therapy)',
  'CPT & CPPT (Cardio-Pulmonary Perfusion Technology)',
  'E&TCT (Emergency and Trauma Care Technology)',
  'B.Optom. (Optometry)',
